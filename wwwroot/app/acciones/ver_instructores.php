<?php
include("verinstructoreslogic.php");
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <div class="detalle-container">
            <div class="left-container">
                ...
                <div class="campo">
                    ...
                    <p><?= htmlspecialchars($registro['experiencia']) ?></p>
                </div>
                ...
                <div class="campo">
                    ...
                    <div class="documentos-container">
                        <div class="documento-item">
                            ...
                            <?php endif; ?>
                            <a href="../config/descargar_archivo_instructores.php?id=<?= $registro['id'] ?>&tipo=cedula"
                                class="btn btn-primary">
                                <i class="bi bi-download"></i> Descargar Cédula
                            </a>
                        </div>
                        <div class="documento-item">
                            <h5>Componentes Docentes:</h5>
                            <?php if ($registro['foto_componentes']): ?>
                                <div class="vista-previa">
                                    <img src="data:<?= $registro['foto_componentes_mime']; ?>;base64,<?= base64_encode($registro['foto_componentes']); ?>"
                                        alt="Vista previa de componentes" class="img-preview">
                                </div>
                            <?php endif; ?>
                            <a href="../config/descargar_archivo_instructores.php?id=<?= $registro['id'] ?>&tipo=componentes"
                                class="btn btn-primary">
                                <i class="bi bi-file-earmark-arrow-down"></i> Descargar Componentes
                            </a>
                        </div>
                    </div>
            ...
            <div class="right-container">
                ...
                <div class="documento-item">
                    ...
                    <?php if ($registro['foto_cv']): ?>
                        ...
                        <?php endif; ?>
                    <?php endif; ?>
                    <a href="../config/descargar_archivo_instructores.php?id=<?= $registro['id'] ?>&tipo=cv"
                        class="btn btn-primary">
