...
<body>
    ...
    <main>
        <div class="video-container" style="display: flex; justify-content: center; align-items: center; height: 100vh;">
            <video controls style="width:75%; border:1rem solid #2c2f33; border-radius: 15px;">
                <source src="video/Manual de Usuario Dashboard.mp4" />
            </video>
        </div>
    </main>
    <footer>
